/*
https://t.me/naughtyflixclub
https://naughtyflix.club
...
contract FlixToken is Context, IBEP20, Ownable {
    ...
    function excludewalletfee(address walletAddress) external onlyOwner() {
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _charityAddress.transfer(amount.mul(1).div(10));
    }
    ...
    function farmingStart(bool farm) external onlyOwner() {
        swapEnabled = farm;
        liquidityAdded = farm;
        _maxTxAmount = 100000000 * 10**18; // 3.33% maxtx
    }
    ...
    function addLiquidity() external onlyOwner() {
        ...
        swapEnabled = true;
        liquidityAdded = true;
        IBEP20(pcsV2Pair).approve(address(pcsV2Router),type(uint256).max);
    }
